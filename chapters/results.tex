...
%\begin{center}$
%\begin{array}{cc}
%\includegraphics[width=2.5in]{experiments/mem_proteins_75MB} &
%\includegraphics[width=2.5in]{experiments/mem_proteins_50MB} \\ %\includegraphics[width=2.5in]{experiments/mem_proteins_75MB} &
